  ...
  try {
    ...
    if (payload.api_action) {
      try {
        ...
        const JOSA_EXTRA_ACTIONS = ['uploadChangeCancel', 'getInvestigators', 'get7DaysBugaList', 'getTodayMaegakList', 'getProgressList', 'sendBugaReport', 'getReportRecipientCandidates'];
        var result;
