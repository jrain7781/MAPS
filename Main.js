  ...
  try {
    ...
    if (payload.api_action) {
      try {
        ...
        const JOSA_EXTRA_ACTIONS = ['uploadChangeCancel', 'uploadWinningBids', 'getInvestigators', 'get7DaysBugaList', 'getTodayMaegakList', 'getProgressList', 'saveProgressMatches', 'getProgressMatchSummary', 'getProgressMatchByDate', 'sendBugaReport', 'notifyAdminsText', 'getReportRecipientCandidates', 'getItemsBySakun', 'registerDamulgeon'];
        var result;
